<html lang="en" class="gr__s_codepen_io"><head>
  ...
  ?>
      ...
      <div class="panel">
        <ul>
          <li><a href="notes10ma1real.php">Real Number</a></li>
          <li><a href="notes10ma1poly.php">Polynomial</a></li>
          <li><a href="notes10ma1Arth.php">Arthematic Equation</a></li>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10ma1par.php">Pair of linear Equation</a></li>
              <li><a href="notes10ma1qd.php">Quaradtic Equation</a></li>
               <li><a href="notes10ma1triangle.php">Triangle</a></li>
          </ul>
      </div>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10matri.php">Tringnometry</a></li>
			   <li><a href="notes10ma1ta.php">Tringnometry Application</a></li>
          </ul>
      </div>
