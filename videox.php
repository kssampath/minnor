                ...
                <ul class="dropdown" style="display: none;">
                  <li><a href="#">Class 9<span class="toggle2"></span></a>
                    <ul class="dropdown2">
                      ...
                      <li><a href="videos9chemistry.html">Chemistry</a></li>
                      <li><a href="videos9maths.html">Maths</a></li>
                      <li><a href="videos9computers.html">Computers</a></li>
                    </ul>
                  </li>
              <li><a href="#">Class 10<span class="toggle2"></span></a>
                    <ul class="dropdown2">
                      
                      <li><a href="videos10physics .html">Physics</a></li>
                      <li><a href="videos10chemistry .html">Chemistry</a></li>
                      <li><a href="videos10maths .html">Maths</a></li>
                      <li><a href="videos10computers .html">Computers</a></li>
                    </ul>
                  </li>
              </ul>
              </li>
                ...
                <ul class="dropdown" style="display: none;">
                  <li><a href="#">Class 9<span class="toggle2"></span></a>
                    <ul class="dropdown2">
                        ...
                        <li><a href="notes9physics .html">Physics</a></li>
                        <li><a href="notes9chemistry .html">Chemistry</a></li>
                        <li><a href="notes9maths.html">Maths</a></li>
                        <li><a href="notes9computers .html">Computers</a></li>
                    </ul>
                  </li>
              <li><a href="#">Class 10<span class="toggle2"></span></a>
                    <ul class="dropdown2">
                      
                        <li><a href="notes10physics.html">Physics</a></li>
                        <li><a href="notes10chemistry .html">Chemistry</a></li>
                        <li><a href="notes10maths.html">Maths</a></li>
                        <li><a href="notes10computers.html">Computers</a></li>
                    </ul>
                  </li>
              </ul>
              </li>
...
<?php
$sql = "SELECT name,link from video where class='$class' and subject='$sub'";
$result=mysqli_query($db,$sql);
 echo "<table>";
if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td><a href='videox.php?id=9&sub=physics&lin=". $row["link"]. "'>" . $row["name"]. "</a></td><td></td></tr>";
	}}
 else {
    echo "0 results";
 }
...
?>
      ...
      <div class="videos">
          <!-- <h1 style="text-align: center">Video Page</h1><br> -->
         <video src="videos/Pexels Videos 5004.mp4" controls autoplay ></video>
         <div class="title"><h4>Video Title <span class="likebtn-wrapper" data-theme="custom" data-btn_size="32" data-f_size="15" data-icon_size="16" data-icon_l="sml3-h" data-icon_d="sml3-u" data-identifier="item_1"></span></h4> </div>
         <div class="upnext">
            <table cellspacing="15">
              <p class="upnext_title">Up Next</p>
              <tr>
                <td>   <a href=""></a>  </td>
              </tr>
              <tr>
