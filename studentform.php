<html lang="en" class="gr__s_codepen_io"><head>
    ...
    <script type="text/javascript">
      ...
      * {
	  ...
	  <center><h1>Inertia.com <br>
  <span
     class="txt-rotate"
     data-period="2000"
     data-rotate='[ "Learn","Share","Rise"]'></span>
</h1>
</center>
      <link href="https://fonts.googleapis.com/css?family=Raleway:200,100,400" rel="stylesheet" type="text/css" />
	  <div class="padd">
	  <h2><b><u>Add information</u></b></h2></br>
    <form action="welcome_get.php" method="get">
<h3>Name : <input type="text" name="name"><br><br>
Gender :
...
class : <input type="text" name="email"><br><br>
School :<input type="text" name="quali"><br><br>
email:<input type="text" name="college"><br><br>
</h3>
</div>
