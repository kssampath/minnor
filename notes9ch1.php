  ...
  ?>
	  ...
	  <div class="w3-container"> 
          <h1 style="text-align: center">Class 9 Chemistry</h1>
		   ...
		   <p>Limitation of “Law of definite proportion”</p><br>
 <p>This law does not hold good when the compound is obtained by using different isotopes of
the combining elements.</p>
<u><strong><u> <br><p>2. John Daltons Atomic Theory</p></strong></u>
 <p>Using his theory, Dalton rationalized the various laws of chemical combination which were
in existence at that time. However, he assumed that the simplest compound of two elements
must be binary.</p>
 <br><p>3. Atoms, Molecules, Ions & Chemical Formula </p>
 <p>Atom</p>
 <p>An atom is the smallest particle of an element which can take part in a chemical reaction. It
may or may not exist freely.</p>
 <p>Each atom of an element shows all the properties of the element. </p>
Molecule</p>
 <p>The smallest particle of matter (element or compound) which can exist in a free state.</p>
 <p>The properties of a substance are the properties of its molecules.</p>
 <br><p><u><strong>MOLECULES OF ELEMENT :</strong></u> The molecules of an element are constituted by the same
type of atoms.</p>
 <br><p><u><strong>MOLECULES OF COMPOUND:</strong></u> Atoms of different elements join together in definite
proportions to form molecules of compounds. (hetero atomic molecules)</p>
 <br><p><u><strong>ATOMICITY:</strong></u> The number of atoms contained in a molecule of a substance (element
or compound) is called its atomic</p>
 <p>Based upon atomicity molecules can be classified as follows.</p>
<br> <p><u><strong>Monoatomic molecules:</strong></u> Noble gases helium, neon and argon exist as He Ne and Ar
respectively.</p>
 <br><p>SYMBOLS</p>
 <p>The abbreviation used to represent an element is generally the first letter in capital of
the English name of element.</p>
 <br><p>Oxygen O Nitrogen N</p>
 <p>When the names of two or more elements begin with the same initial letter, the initial
letter followed by the letter appearing later in the name is used to symbolize the
element</p>
 <p>Barium Ba Bismuth Bi</p>
<a href="atom_and_molecules.pdf">Click here to download</a>
	  </div>
	   </diV>
