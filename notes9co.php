<html lang="en" class="gr__s_codepen_io"><head>
  ...
  ?>
     ...
     <button class="accordion">Section 1</button>
      <div class="panel">
        <ul>
          <li><a href="notes9comp1.php">Fundamentals of Computer</a></li>
          <li><a href="notes9comp2.php">Fundamentals of Operating System</a></li>
          <li><a href="notes9comp3.php">Office Automation</a></li>
        </ul>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes9comp4.php">INPUTOUT DEVICES</a></li>
              <li><a href="notes9comp5.php">Data Communication</a></li>
      ...
      <div class="panel">
          <ul>
              <li><a href="CHAPTER 4 STORAGE DEVICES.pdf">STORAGE DEVICES.pdf</a></li>
              <li><a href="CHAPTER 5 NUMBER SYSTEM.pdf">NUMBER SYSTEM</a></li>
              <li><a href="CHAPTER 6 BOOLEAN ALGEBRA.pdf">BOOLEAN ALGEBRA</a></li>
          </ul>
      </div>
