 ...
 -webkit-stroke-width: 5.3px;
  ...
  ?>
	  ...
	  <div class="w3-container"> 
		  ...
		  <p>Voluntary means it is under the control of a person (e.g. writing)
Involuntary means it is not under the control of a person. (e.g. heartbeat)
<u><strong><u>Mechanism of Reflex action:</strong></u></p><br> A reflex mechanism involves a receptor organ, an effector
organ, and some type of communication network. <p>When a sensory receptor is stimulated,
signals pass from it along a sensory neuron to the spinal cord.</p><br> <p>The message travels out of the
spinal cord along a motor neuron to the effector organ (e.g., a muscle or a gland), which
shows the response. Such a pathway is called a reflex arc.</p><br><p> In most cases, however, the basic
physiological mechanism behind a reflex is more complicated than the reflex arc theory
would suggest. Additional nerve cells capable of communicating with other parts of the body
(beyond the receptor and effector) are present in reflex circuits.</p><br><p>
HUMAN NERVOUS SYSTEM : The nervous system of vertebrates (including humans) is
divided into the central nervous system (CNS) and the peripheral nervous system (PNS).
The (CNS) is the major division, and consists of the brain and the spinal cord. The spinal
canal contains the spinal cord, while the cranial cavity contains the brain.</p><br><p>
<u><strong><u>Human Brain :</strong></u> It is enclosed in cranium (brain box) and is protected by
cerebrospinal fluid which acts as a shock absorber. Human brain has three major
parts or regios : (a) Fore-brain (b) Mid Brain (c) Hind Brain.</p>
<p>(a) Fore-brain(CEREBRUM)</p><br><p>
Most complex/specialized part of the brain is Cerebrum or the forebrain.
Functions</p><br><p>
1. Thinking part of the brain<br>
2. Control the voluntary actions.<br>
3. Store information(Memory)<br>
4. Centre associated with HUNGER<br>
5. Receives sensory impulses from various body parts and integrates it</p><p>
(b) Mid Brain</p><br>
<p>
It connects the fore-brain with the hind-brain. It is the portion of the central nervous system
associated with vision, hearing, motor control, sleep/wake, arousal (alertness), and
temperature regulation</p><br>
<a href="10_science_notes_07_Control_and_Coordination_1.pdf">Click here to download</a>
	  </div>
	   </diV>
