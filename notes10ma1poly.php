  ...
  ?>
	  ...
	  <div class="w3-container"> 
          <h1 style="text-align: center">Class 10 Maths</h1>
           <!-- .............accordion.......
		   ....... -->
		  <p> 1. Geometrical Meaning of the Zeroes of a Polynomial </p>
<p>2. Zeroes and Coefficients of a Polynomial </p>
 <p>3. Division Algorithm for Polynomials </p>
 <p>1. Monomials: Algebraic expression with one term is known as Monomial. </p>
 <p>2. Binomial: Algebraic expression with two terms is called Binomial. </p>
 <p>3. Trinomial: Algebraic expression with three terms is known as Trinomial. </p>
 <p>4. Polynomials: All above mentioned algebraic expressions are called Polynomials. </p>
 <p>5. Polynomials of degrees 1, 2 and 3 are called linear, quadratic and cubic polynomials
respectively. </p>
 <p>6. A quadratic polynomial in x with real coefficient is of the form ,where a,
b, c are real numbers with . </p>
 <p>7. The zeroes of a polynomial p(x) are precisely the x–coordinates of the points where the
graph of y = p(x) intersects the x-axis i.e. x = a is a zero of polynomial p(x) if p(a) = 0. </p>
 <p>8. A polynomial can have at most the same number of zeros as the degree of polynomial. </p>
 <p>9. For quadratic polynomial </p>
 <p>Sum of zeroes = </p>
 <p>Product of zeroes = </p>
 <p>10. In a cubic polynomial , if are the zeroes of the polynomial,
then </p>
 <p>11. The division algorithm states that given any polynomial p(x) and polynomial g(x), there
Material downloaded from myCBSEguide.com. </p>

 <p>are polynomials q(x) and r(x) such that : </p>
 <p>where r(x) = 0 or degree of r(x) < degree of g(x).
Or Dividend = Divisor x Quotient + Remainder </p>
 <p>If r(x) = a zero polynomial, then p(x) is said to be completely divisible by g(x), i.e., g(x) is a
factor of p(x). <//p>
 <a href="10_maths_key_notes_ch_02_polynomials.pdf">cilck here for download</a>
   </diV>
    </diV>
      <script>
