<html lang="en" class="gr__s_codepen_io"><head>
  ...
  ?>
      ...
      <div class="panel">
        <ul>
          <li><a href="notes10ch1.php">Chemical reaction and Equation</a></li>
          <li><a href="notes10ch4.php">Acid and Bases</a></li>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10ch3.php">Periodic Classification of Elements</a></li>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10ch5.php">Life Process</a></li>
          </ul>
      </div>
