  ...
  ?>
	  ...
	  <div class="w3-container"> 
          <h1 style="text-align: center">Class 10 Maths</h1>
           <!-- .............accordion.............. -->
   <p><u><strong>Natural numbers:</strong></u> Counting numbers are called Natural numbers. These numbers
are denoted by N = {1, 2, 3, .........}</p>
<p><u><strong>Whole numbers:</strong></u> The collection of natural numbers along with 0 is the collection of
Whole number and is denoted by W.</p>
<p><u><strong>Integers:</strong></u> The collection of natural numbers, their negatives along with the number
zero are called Integers. This collection is denoted by Z.</p>
<p>Rational number: The numbers, which are obtained by dividing two integers, are
called Rational numbers. Division by zero is not defined.</p>
<p>Coprime: If HCF of two numbers is 1, then the two numbers area called relatively
prime or coprime.</p>
<p><u><strong>1. Euclid’s division lemma :</strong></u>
For given positive integers ‘a’ and ‘b’ there exist unique whole numbers ‘q’ and ‘r’ satisfying
the relation .</p>
<p>Theorem: If and are non-zero integers, the least positive integer which is expressible as a
...
The HCF of and is denoted by HCF .</p>
<p><u><strong>2. Euclid’s division algorithms :</strong></u></p>
<p>HCF of any two positive integers a and b. With a > b is obtained as follows:</p>
<p>Step II: If r = 0, HCF (a,b)=b if , apply Euclid’s lemma to b and r.</p>
<p>Step III: Continue the process till the remainder is zero. The divisor at this stage will be the
required HCF.<p>
<p><u><strong>3. The Fundamental Theorem of Arithmetic :</strong></u>
Every composite number can be expressed (factorized) as a product of primes and this
factorization is unique, apart from the order in which the prime factors occur.</p>
<p>4. Let to be a rational number, such that the prime factorization of ‘q’ is of the
form 2m+5n, where m, n are non-negative integers. Then x has a decimal expansion which is
terminating.</p>
<p>5. Let be a rational number, such that the prime factorizationof q is not of the
form 2m+5n, where m, n are non-negative integers. Then x has a decimal expansion which is
non-terminating repeating.</p>
<p>6. is irrational, which p is a prime. A number is called irrational if it cannot be written in
the form where p and q are integers and
<p>8. If a and b are two positive integers, then HCF(a, b) x LCM(a, b) = a x b
i.e., (HCF x LCM) of two intergers = Product of intergers.</p>
<p>9. A rational number which when expressed in the lowest term has factors 2 or 5 in the
...
expansion.</p>
<a href="10_maths_key_notes_ch_01_real_numbers.pdf">Click here a download</a>
  </diV>
   </diV>
      <script>
