...
acids and bases. <p>
 ...
 <p><u><strong>Formation of OH–<u><strong>(aq) ions in solution is responsible for the basic nature of a
substance. </p><br>
...
corresponding salt, carbon dioxide gas and water. </p>
 <br><p>Acidic and basic solutions in water conduct electricity because they produce hydrogen
and hydroxide ions respectively. <p>
 <p>The strength of an acid or an alkali can be tested by using a scale called the pH scale
(0-14) which gives the measure of hydrogen ion concentration in a solution.
A neutral solution has a pH of exactly 7, while an acidic solution has a pH less than 7
and a basic solution a pH more than 7. </p><br>
...
each formula unit of a salt in its crystalline form. </p>
 <p>Salts have various uses in everyday life and in industries. </p>
<a href="10_science_notes_02_Acid_Bases_and_Salts_1">click here to download</a>
</diV>
   </diV>
      <script>
