<html lang="en" class="gr__s_codepen_io"><head>
    ...
    <script type="text/javascript">
      ...
      * {
             ...
             <li><a href="#">Notes<span class="toggle"></span></a>
              ...
              <li><a href="#">Class 10<span class="toggle2"></span></a>
                    ...
                    <li><a href="notes.php?id=10&sub=physics">Physics</a></li>
                      ...
                      <li><a href="notes.php?id=10&sub=maths">Maths</a></li>
                      <li><a href="notes.php?id=10&sub=computer">Computers</a></li>
                    </ul>
                  </li>
              </ul>
              </li>
      ...
      <div class="videos">
          <h1 style="text-align: center">Class <?php echo $_GET['id']?>  <?php echo $_GET['sub']?></h1>
           <!-- .............accordion.............. -->
