<html lang="en" class="gr__s_codepen_io"><head>
 ...
 -webkit-stroke-width: 5.3px;
  ...
  ?>
	  ...
	  <?$class=$_GET['id'];
$sub=$_GET['sub'];?>
	<center>  <h1>Class <?php echo $_GET['id']; ?> <?php echo $_GET['sub']; ?></h1> </center>
...
echo "<center>";
 echo "<table>";
 echo "<th><b><h1>CHAPTER</h1><b></th>";
if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td><Br><a href=" . $row["link"]. " target='_blank'>" . $row["name"]. "</a><br></td><td></td></tr>";
