<html lang="en" class="gr__s_codepen_io"><head>
  ...
  ?>
      ...
      <div class="panel">
        <ul>
          <li><a href="notes10ph1.php">Control and Cordination</a></li>
          <li><a href="notes10ph3.php">Evolution</a></li>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10ph2.php">Light Reflection and Refraction</a></li>
          </ul>
      </div>
      ...
      <div class="panel">
          <ul>
              <li><a href="notes10ph4.php">Organism Reproduction</a></li>
