<html lang="en" class="gr__s_codepen_io"><head>
  ...
  ?>
	  ...
	  <div class="w3-container"> 
          <h1 style="text-align: center">Class 9 Maths</h1>
           <!-- .............accordion.............. -->
   <p> <u><strong><u>1. Quadratic Equations</strong></u></p>
<p><u><strong>2. Solution by Factorisation</strong></u></p>
<p><u><strong>3. Solution by Completing the Square</strong></u></p>
<p><u><strong>4. Nature of Roots</strong></u></p>
<p>1. The equation , is the standard form of a quadratic equation, where a,
b and c are real numbers
is known as Standard form or General form of a quadratic
equation.</p>
<p>In other words, we can say that an equation of order (degree) 2 is called a quadratic
equation.</p>
<p>2. A real number is said to be a root of the quadratic equation 
. If the zeroes of quadratic polynomial and the
roots of the the quadratic equation are the same.</p>
<p>3. If we can factorise into product of two linear factors,then
the roots of the quadratic equation can be found by equating each factors to zero.</p>
<p>4. The roots of a quadratic equation , are given by
provided that . It is called Quadratic formula.</p>
<p>5. A quadratic equation , has :</p>
<p>(a) Two distinct and real roots, if</p>
<p>(b) Two equal and real roots, if</p>
<p>(c) Two roots are not real, if</p>
<p>6. A quadratic equation can also be solved by the method of completing the square.</p>
<p>7. Discriminant of the quadratic equation , is givenby</p>
.
    <a href="10_maths_key_notes_ch_04_quadratic_equation.pdf">click here for download</a>
        </diV>
		 </diV>
      <script>
